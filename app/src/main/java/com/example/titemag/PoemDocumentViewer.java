...
public class PoemDocumentViewer extends AppCompatActivity {
    WebView web;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poem_document_viewer);
        ...
        AlertDialog.Builder builder= new AlertDialog.Builder(PoemDocumentViewer.this);
